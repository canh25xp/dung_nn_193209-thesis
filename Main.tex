...
\newpage
\subfile{Chapter/0_1_preface.tex}
...
\newpage
\subfile{Chapter/0_4_guarantee.tex}
% ===================================================
% \pagestyle{empty} % Header và footer rỗng
\newpage
...
\subfile{Chapter/2_Theoretical_background.tex}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{HIGH-LEVEL REQUIREMENTS}
\label{chapter:Methodology}
\subfile{Chapter/3_Requirements}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{RESULT}
\label{chapter:Experiment}
\subfile{Chapter/4_Result}
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CONCLUSION} %Kết luận và hướng phát triển}
...
[1] Oliver Gierke, Thomas Darimont, Christoph Strobl, Mark Paluch. 2017. Spring Data JPA - Reference Documentation.

[2] Donald Bell. 2010. UML basics. Part II: The activity diagram. The activity diagram's purpose. by Donald Bell IBM Global Services.

[3] https://developers.momo.vn/v3/vi/docs/payment/api/wallet/onetime

[4] https://stackoverflow.com/

[5] Mô hình MVC trong JAVA web JSP/Servlet là gì? – itphutran.com
